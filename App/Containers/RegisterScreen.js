      ...
      >
        <Content
          ...
          contentContainerStyle={[
            Fonts.style.justifyAlignCenter,
            {
              height: "95%",
        ...
        <Successmodal isModalVisible={modalVisible} toggleModal={toggleModal} />
      </Container>
    </Root>
  );
};
